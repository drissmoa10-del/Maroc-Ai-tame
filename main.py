...
def generate_content(idea, chat_id):
    ...
    try:
        ...
        pending_content['result'] = full_output
...
def handle_callbacks(call):
    ...
    if call.data == "approve_yt":
        ...
        result_text = pending_content.get('result', "عنوان الفيديو التقني")
