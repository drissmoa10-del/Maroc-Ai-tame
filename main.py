...
# حماية تامة ضد انهيار السيرفر إذا كان شي متغير خاوي
...
# استخدام الموديل المستقر 100% والمحدث
model = genai.GenerativeModel('gemini-1.5-flash-latest')

# تهيئة البوت فقط إذا كان التوكن موجوداً لتفادي الانهيار
...
if __name__ == "__main__":
    if bot:
        ...
        logging.error("تعذر بدء تشغيل البوت لعدم توفر التوكن.")
